...
echo ""
echo "After reboot, if you use PostgreSQL or PHP-FPM (Piwigo, Ampache, FreshRSS),"
echo "run the 'PostgreSQL 15→17' and 'PHP-FPM migration to default PHP' interactables from Admin → Updates."
echo "Those migrations can fuck your shit up; run them when ready."
echo ""
